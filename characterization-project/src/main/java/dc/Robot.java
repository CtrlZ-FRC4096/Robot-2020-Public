...
public class Robot extends TimedRobot {
  ...
  static private double ENCODER_EDGES_PER_REV = 8078 / 4.;
  static private int PIDIDX = 0;
  static private int ENCODER_EPR = 8078;
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_VictorSPX leftMotor = setupWPI_VictorSPX(3, Sides.LEFT, true);

    ArrayList<SpeedController> leftMotors = new ArrayList<SpeedController>();
    leftMotors.add(setupWPI_VictorSPX(4, Sides.FOLLOWER, true));
    leftMotors.add(setupWPI_VictorSPX(5, Sides.FOLLOWER, true));
    ...
    WPI_VictorSPX rightMotor = setupWPI_VictorSPX(0, Sides.RIGHT, true);
    ArrayList<SpeedController> rightMotors = new ArrayList<SpeedController>();
    rightMotors.add(setupWPI_VictorSPX(1, Sides.FOLLOWER, true));
    rightMotors.add(setupWPI_VictorSPX(2, Sides.FOLLOWER, true));
