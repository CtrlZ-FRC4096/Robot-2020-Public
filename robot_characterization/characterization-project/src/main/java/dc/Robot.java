...
public class Robot extends TimedRobot {
  ...
  static private double WHEEL_DIAMETER = 6.125;
  static private double ENCODER_EDGES_PER_REV = 3657.14 / 4.;
  ...
  public void robotInit() {
    ...
    leftMotors[0] = new VictorSP(1);
    leftMotors[1] = new VictorSP(2);

    SpeedController[] rightMotors = new SpeedController[2];
    rightMotors[0] = new VictorSP(4);
    rightMotors[1] = new VictorSP(5);
